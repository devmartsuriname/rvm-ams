...
import { Card, CardBody, CardHeader, Row, Col, Button, Tabs, Tab } from 'react-bootstrap'
...
import DossierDocumentsTab from '@/components/rvm/DossierDocumentsTab'
    ...
    <>
      ...
      <Tabs defaultActiveKey="details" className="mb-3">
        ...
        <Tab eventKey="documents" title="Documents">
          <DossierDocumentsTab dossierId={dossier.id} />
        </Tab>
      </Tabs>
